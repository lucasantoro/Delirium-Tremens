...
TAGLINES = {
    ...
    "orcuss": "Diplomazia a colpi d'ascia",
...
SUMMARIES = {
    ...
    "crytdh": "Chiude ogni distanza in un attimo e non concede tregua al bersaglio.",
    ...
    "orcuss": "Arms diretto e pesante: ogni apertura diventa un colpo importante.",
...
BIOS = {
    ...
    "crytdh": "Crytdh vede una distanza e la considera un'offesa personale. Un balzo, una carica e si ritrova gia dall'altra parte del boss, lasciando al resto del raid il compito di capire come.",
    ...
    "orcuss": "Orcuss non e contrario alla diplomazia, purche preveda un'arma a due mani. Quando arriva il momento di chiudere una fase, le argomentazioni diventano molto convincenti.",
